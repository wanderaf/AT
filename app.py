...
def plot_pass_map(events_df, player_name):
    ...
    successful_passes = len(passes[passes['pass_outcome'].isna()])  # Passes bem-sucedidos são aqueles sem "pass_outcome"
...
# Session State para manter interações do usuário
if 'match_id' not in st.session_state:
    st.session_state['match_id'] = None

# Menu para navegar entre as seções
menu = st.sidebar.selectbox('Selecione uma Seção', ['Análise da Partida', 'Análise do Jogador', 'Comparativo de Jogador'])

# Lógica combinada para filtrar por competição, temporada e partida (sem jogador)
...
# Carregar estatísticas e eventos da partida segregadas por clube
